const Footer = () => {
  return (
    <footer className="relative overflow-hidden px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-white mt-10 pt-10">
      
      {/* Background SVG */}
      <svg className="hidden md:block absolute -bottom-30 -left-80 opacity-5 w-full h-full pointer-events-none" width="68" height="26" viewBox="0 0 68 26" fill="none">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        ...
        <div className="sm:col-span-2 lg:col-span-1">
          <h1 className="text-xl font-bold text-black">E-Library</h1>
          <p className="text-sm/7 mt-6">
            Discover, read, and explore thousands of books online anytime with our modern digital library platform.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:items-center lg:justify-center">
          <div className="flex flex-col text-sm space-y-2.5">
            ...
            <a className="hover:text-slate-600" href="#">About</a>
        ...
        <div>
          ...
          <div className="space-y-6 max-w-sm">
            <p>Get latest books and updates directly in your inbox.</p>
            <div className="flex items-center">
              <input className="rounded-l-md bg-gray-100 w-full h-11 px-3 outline-none" type="email" placeholder="Enter your email" />
              <button className="bg-black text-white px-4 h-11 rounded-r-md">
                Subscribe
              </button>
            </div>
          </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-4 border-t mt-6 border-slate-200">
        <p>© 2026 E-Library. All rights reserved.</p>
